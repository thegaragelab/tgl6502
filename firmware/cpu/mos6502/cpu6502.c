...
static uint8_t g_MODE[] = {
  (MODE_IMP<<4)|MODE_INDX,  (MODE_IMP<<4)|MODE_INDX, (MODE_ZP<<4)|MODE_ZP,     (MODE_ZP<<4)|MODE_ZP,
  (MODE_IMP<<4)|MODE_IMM,   (MODE_ACC<<4)|MODE_IMM,  (MODE_ABSO<<4)|MODE_ABSO, (MODE_ABSO<<4)|MODE_ABSO,
  (MODE_REL<<4)|MODE_INDY,  (MODE_IMP<<4)|MODE_INDY, (MODE_ZPX<<4)|MODE_ZPX,   (MODE_ZPX<<4)|MODE_ZPX,
  (MODE_IMP<<4)|MODE_ABSY,  (MODE_IMP<<4)|MODE_ABSY, (MODE_ABSX<<4)|MODE_ABSX, (MODE_ABSX<<4)|MODE_ABSX,
  (MODE_ABSO<<4)|MODE_INDX, (MODE_IMP<<4)|MODE_INDX, (MODE_ZP<<4)|MODE_ZP,     (MODE_ZP<<4)|MODE_ZP,
  (MODE_IMP<<4)|MODE_IMM,   (MODE_ACC<<4)|MODE_IMM,  (MODE_ABSO<<4)|MODE_ABSO, (MODE_ABSO<<4)|MODE_ABSO,
  (MODE_REL<<4)|MODE_INDY,  (MODE_IMP<<4)|MODE_INDY, (MODE_ZPX<<4)|MODE_ZPX,   (MODE_ZPX<<4)|MODE_ZPX,
  (MODE_IMP<<4)|MODE_ABSY,  (MODE_IMP<<4)|MODE_ABSY, (MODE_ABSX<<4)|MODE_ABSX, (MODE_ABSX<<4)|MODE_ABSX,
  (MODE_IMP<<4)|MODE_INDX,  (MODE_IMP<<4)|MODE_INDX, (MODE_ZP<<4)|MODE_ZP,     (MODE_ZP<<4)|MODE_ZP,
  ...
  (MODE_IMP<<4)|MODE_ABSY,  (MODE_IMP<<4)|MODE_ABSY, (MODE_ABSX<<4)|MODE_ABSX, (MODE_ABSX<<4)|MODE_ABSX,
  (MODE_IMP<<4)|MODE_INDX,  (MODE_IMP<<4)|MODE_INDX, (MODE_ZP<<4)|MODE_ZP,     (MODE_ZP<<4)|MODE_ZP,
  (MODE_IMP<<4)|MODE_IMM,   (MODE_ACC<<4)|MODE_IMM,  (MODE_IND<<4)|MODE_ABSO,  (MODE_ABSO<<4)|MODE_ABSO,
  (MODE_REL<<4)|MODE_INDY,  (MODE_IMP<<4)|MODE_INDY, (MODE_ZPX<<4)|MODE_ZPX,   (MODE_ZPX<<4)|MODE_ZPX,
  (MODE_IMP<<4)|MODE_ABSY,  (MODE_IMP<<4)|MODE_ABSY, (MODE_ABSX<<4)|MODE_ABSX, (MODE_ABSX<<4)|MODE_ABSX,
  (MODE_IMM<<4)|MODE_INDX,  (MODE_IMM<<4)|MODE_INDX, (MODE_ZP<<4)|MODE_ZP,     (MODE_ZP<<4)|MODE_ZP,
  (MODE_IMP<<4)|MODE_IMM,   (MODE_IMP<<4)|MODE_IMM,  (MODE_ABSO<<4)|MODE_ABSO, (MODE_ABSO<<4)|MODE_ABSO,
  (MODE_REL<<4)|MODE_INDY,  (MODE_IMP<<4)|MODE_INDY, (MODE_ZPX<<4)|MODE_ZPX,   (MODE_ZPY<<4)|MODE_ZPY,
  (MODE_IMP<<4)|MODE_ABSY,  (MODE_IMP<<4)|MODE_ABSY, (MODE_ABSX<<4)|MODE_ABSX, (MODE_ABSY<<4)|MODE_ABSY,
  (MODE_IMM<<4)|MODE_INDX,  (MODE_IMM<<4)|MODE_INDX, (MODE_ZP<<4)|MODE_ZP,     (MODE_ZP<<4)|MODE_ZP,
  (MODE_IMP<<4)|MODE_IMM,   (MODE_IMP<<4)|MODE_IMM,  (MODE_ABSO<<4)|MODE_ABSO, (MODE_ABSO<<4)|MODE_ABSO,
  (MODE_REL<<4)|MODE_INDY,  (MODE_IMP<<4)|MODE_INDY, (MODE_ZPX<<4)|MODE_ZPX,   (MODE_ZPY<<4)|MODE_ZPY,
  (MODE_IMP<<4)|MODE_ABSY,  (MODE_IMP<<4)|MODE_ABSY, (MODE_ABSX<<4)|MODE_ABSX, (MODE_ABSY<<4)|MODE_ABSY,
...
void cpuStep() {
  ...
  uint8_t id = g_MODE[opcode >> 1];
  id = (opcode&0x01)?(id&0x0F):(id>>4);
